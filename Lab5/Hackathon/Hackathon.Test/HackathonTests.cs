...
public class HackathonTests
{
    ...
    public void HackathonStabilityTest_AllHarmonicMeansShouldBeSame()
    {
        ...
        var hackathon =
            new Hackathon(20, new TeamBuildingStrategy(), new SimpleWishListGenerator(), dataLoader);
        //Act
        hackathon.Run();
        ...
        for (var i = 0; i < 5; i++)
        {
            hackathon = new Hackathon(20, new TeamBuildingStrategy(), new SimpleWishListGenerator(),
                dataLoader);
            hackathon.Run();
